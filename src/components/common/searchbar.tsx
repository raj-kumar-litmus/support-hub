  ...
  return (
    <div className="block">
      <span className="search-input p-input-icon-left hidden sm:block">
        ...
        <CustomInputText
          type="text"
          className={`w-[15.6rem] h-[2.5rem] !rounded-full focus:outline-none  bg-[#30343B] text-[#FAF9F6] placeholder:text-[#FAF9F6] placeholder:font-helvetica placeholder:font-normal !shadow-none !border-none ${className}`}
