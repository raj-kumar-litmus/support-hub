...
const WebServerCard: React.FC<ApiWebServerCard> = (props) => {
  ...
  return (
    <>
      <div
        className={`mt-1.5 flex flex-row max-w-[198px] h-9 border-2 border-gray-108 text-white-100 rounded-xl cursor-pointer font-helvetica
          !bg-black-101 
      ...
      >
        <div className="pl-3 mt-0.5 w-65pr h-9">
          <div
            className="w-20 text-10 text-ellipsis overflow-x-hidden whitespace-nowrap uppercase"
